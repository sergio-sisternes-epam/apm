...
def generate_deep_tree_fixtures(base_dir: Path, n_packages: int = 100, max_depth: int = 10) -> Dict[str, Path]:
...
def generate_primitive_heavy_package(base_dir: Path, n_instructions: int = 200, n_contexts: int = 50) -> Path:
